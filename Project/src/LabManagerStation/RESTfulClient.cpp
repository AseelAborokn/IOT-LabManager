...
void RESTfulClient::initRESTClient(){
 ...
 */
String RESTfulClient::createRequest(String hostName, String path, String query) {
  return ("http://" + hostName + "/" + path + query);
}

bool RESTfulClient::httpGetRequest(String request, String *payload) {
  HTTPClient http;
...
bool RESTfulClient::httpPostRequest(String request, String type, String (*getData)()) {
  WiFiClient client;
  HTTPClient http;
