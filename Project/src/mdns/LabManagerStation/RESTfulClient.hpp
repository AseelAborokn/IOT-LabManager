...
class RESTfulClient {
  private:
     ...
     */
    static String createRequest(String hostName, String path, String query);
     ...
     */
    static bool httpGetRequest(String request, String *payload);
     ...
     * @return
     */
    static bool httpPostRequest(String request, String type, String (*getData)());
  ...
  public:
     ...
     * @param hostName - The host IP_ADDRESS / SSID (192.168.1.106:1880)
     * @param path - The url route (update-sensor)sss
     * @param query - The query to add to the route (?temperature=24.37)
